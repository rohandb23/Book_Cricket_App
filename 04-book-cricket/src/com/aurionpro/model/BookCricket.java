...
public class BookCricket {
	...
	public static String playerOneScore(String name) {
		...
		while(turnScore!=0) {
			...
			System.out.println("book page number : "+random+"\tpoint : "+turnScore+"\tScore : "+runsOfPlayerOne);
		}
		turnsFinal=turns;
	...
	public static String playerTwoScore(String name) {
		while(runsOfPlayerOne>runsOfPlayerTwo) {
			while(turnsFinal>0) {
				...
				System.out.println("book page number : "+random+"\tpoint : "+turnScore+"\tScore : "+runsOfPlayerTwo);
			}
			break;
		}
